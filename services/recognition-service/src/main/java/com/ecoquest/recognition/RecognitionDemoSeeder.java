...
class RecognitionDemoSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        profile("SV001", 44, 1, 1);
        profile("SV002", 52, 1, 0);
        profile("SV003", 41, 1, 0);
        profile("SV004", 32, 1, 0);
        profile("SV005", 82, 1, 1);
        profile("SV006", 91, 1, 1);
        profile("SV007", 42, 1, 0);
        profile("SV008", 46, 1, 1);
        ...
        reward("reward-eco-kit", "EcoQuest Starter Kit", "Reusable campus bottle and sticker pack for certificate holders.",
                "leaf", "#0D4736", 90, 3, 2, 35,
                Instant.now().plus(75, ChronoUnit.DAYS), "Requires sustained points, badges, and at least two issued certificates.");
        reward("reward-merch", "Sustainability Merch Coupon", "15% off official EcoQuest sustainability merchandise.",
                "shirt", "#D97706", 140, 4, 2, 50,
                Instant.now().plus(100, ChronoUnit.DAYS), "Limited stock for top campus sustainability contributors.");
    }
